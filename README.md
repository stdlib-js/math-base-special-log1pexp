...
```javascript
import log1pexp from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-log1pexp@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-log1pexp/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-base-special-log1pexp/actions/workflows/test.yml?query=branch:v0.2.2
