...
var log1pexp = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( log1pexp instanceof Error )
};
...
tape( 'the function computes the natural logarithm of `1+exp(x)` (`x <= -37`)', opts, function test( t ) {
	var x;
	var y;
	var v;
	var i;
...
tape( 'the function computes the natural logarithm of `1+exp(x)` (`x > 33.3`)', opts, function test( t ) {
	var x;
	var v;
	var i;
